...
int main(int argc, char * argv[])
{
  ...
  factory.registerFromPlugin(loader.getOSName("br2_is_object_bt_node"));
  factory.registerFromPlugin(loader.getOSName("br2_search_object_bt_node"));
  factory.registerFromPlugin(loader.getOSName("br2_follow_ball_bt_node"));
